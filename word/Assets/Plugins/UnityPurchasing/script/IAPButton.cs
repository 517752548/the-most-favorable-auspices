...
namespace UnityEngine.Purchasing
{
	...
	public class IAPButton : MonoBehaviour
	{
	    ...
	    public GameObject NotinitGameObject;
		...
		void OnEnable()
		{
            ...
            IAPButtonStoreManager.Instance.Initloading();
	    ...
	    private void NotInit(bool bol)
	    {
	        if (NotinitGameObject != null)
	        {
                Debug.Log("…Ë÷√" + bol);
                NotinitGameObject.SetActive(bol);
            }
